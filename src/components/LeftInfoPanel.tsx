...
export const LeftInfoPanel = () => {
  return (
    <div className="h-auto flex flex-col p-[25px] pb-0 max-w-[900px] select-none md:h-full md:p-10 md:pr-20 md:pb-0">
      {/* Name */}
      <h2 className="text-[14vw] font-medium leading-[1em] mt-0 mb-[55px] relative left-0 md:text-[5.2rem] md:mt-[55px] md:left-[-7px]">
        Marcus Chen
      </h2>
      ...
      <div className="space-y-[30px] text-2xl font-medium pl-5 -ml-[25px]">
        ...
        <a
          href="mailto:studio@marcuschen.com"
          className="block font-medium hover:opacity-50 transition-opacity duration-300"
        >
          studio@marcuschen.com
        </a>

        <a
          href="http://instagram.com/marcuschen"
          target="_blank"
